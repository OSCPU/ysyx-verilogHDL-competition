...
ifeq ($(wildcard $(COMB_LOCK_HOME)/scripts/tracer.mk),)
  $(error $(COMB_LOCK_HOME) is not a comblock repository)
endif
...
WORK_INDEX    = $(COMB_LOCK_HOME)/.git/index.$(WORK_KEY)
TRACER_BRANCH = $(TRACER)

LOCK_DIR = $(COMB_LOCK_HOME)/.git/
...
define git_commit
	-@flock $(LOCK_DIR) $(MAKE) -C $(COMB_LOCK_HOME) -f scripts/tracer.mk .git_commit MSG='$(1)'
	-@sync $(LOCK_DIR)
endef
